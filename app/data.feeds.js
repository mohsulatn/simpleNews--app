var feeds = [
...

    {
        ...
        "selector": {"item": "span.item_title > a", "title": "span.item_title > a", "href": "span.item_title > a"},
        "type": "html",
        "desc": "创意工作者们的社区"
    }, {
        "name": "简书",
    ...
    },
    {
        ...
        "name": "什么值得买热门2小时",
        "selector": {"item": ".list", "title": ".itemName>a", "href": ".itemName>a", "next": ".pagedown>a"},
        "type": "html",
        ...
        "name": "京东众筹",
        "type": "html",
        "selector": {"item": ".query-result-list", "title": ".link-tit", "href": ".i-tits>a"},
        "desc": "京东金融综合互联网理财服务"
    }];
